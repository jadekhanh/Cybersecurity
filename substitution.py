...
#Build a list containing all alphabet uppercase letters (A-Z)
# letters = [chr(x) for x in range(65,91)] 
# letters = [chr(x) for x in range(65, 91)] + [' '] # I added
...
# #Build the 1-1 mapping between each plaintext letter and its ciphertext
# while len(letters) > 0:
...
# # I added: Add space character to the substitution dictionary
# substitution[' '] = ' '
# substitution[','] = ','
# substitution['.'] = '.'
# substitution[';'] = ';'
